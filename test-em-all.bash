...
# 2.8.3 assertCurl 200 "curl -ks  https://$HOST:$PORT/openapi/webjars/swagger-ui/index.html?configUrl=/v3/api-docs/swagger-config"
# 2.8.4 assertCurl 200 "curl -ks  https://$HOST:$PORT/openapi/swagger-ui/index.html"
